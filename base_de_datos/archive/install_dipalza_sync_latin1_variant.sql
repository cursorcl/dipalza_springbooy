...
CREATE TABLE dbo.configuracion (
    propiedad   varchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
    valor       varchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE dbo.historial_posicion (
    id         bigint IDENTITY(1,1) NOT NULL,
    vendedorId varchar(3) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,

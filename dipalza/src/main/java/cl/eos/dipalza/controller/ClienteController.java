...
public class ClienteController {
    ...
    @GetMapping("/vendedor")
    public List<ClienteDTO> getClienteByVendedor(@RequestParam(required = true) String codigoVendedor) {
        return clienteService.getClientesByVendedor(codigoVendedor);
    }
